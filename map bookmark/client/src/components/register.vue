          ...
          <form @submit.prevent="registerUser">
            ...
            <div class="login-form-body">
              <div class="form-gp">
                ...
                <input class="form-control" type="text" v-model="name" id="exampleInputName1" placeholder="Full Name" required/>
                <!-- <i class="ti-user"></i> -->
              </div>
              <div class="form-gp">
                <!-- <label for="exampleInputEmail1">Email address</label> -->
                <label class="fromto">Your Email:</label> <br>
                <input class="form-control" type="email" v-model="email" id="exampleInputEmail1" placeholder="Email address" required/>
                <!-- <i class="ti-email"></i> -->
              </div>
              <div class="form-gp">
                <!-- <label for="exampleInputPassword1">Password</label> -->
                <label class="fromto">Creat Password:</label> <br>
                <input class="form-control" v-model="password" type="password" id="exampleInputPassword1" placeholder="Password" required/>
                <!-- <i class="ti-lock"></i> -->
              </div>
              <div class="form-gp">
                <!-- <label for="exampleInputPassword2">Confirm Password</label> -->
                <label class="fromto">Confirm Your Password:</label> <br>
                <input class="form-control" type="password" v-model="password_confirm" id="exampleInputPassword2" placeholder="Confirm Password" required/>
                <!-- <i class="ti-lock"></i> -->
              </div>
              <div class="submit-btn-area">
                ...
                <div class="login-other row mt-4">
                  <div class="col-6 facebook">
                    <a class="fb-login" href="#">Sign up with
                      <span style="
                        font-weight: bold;
                        font-size: 15px;
                  ...
                  <div class="col-6 google">
                    <a class="google-login" href="#">Sign up with
